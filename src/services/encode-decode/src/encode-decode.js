// #FIXME DA FAK is DIS BRO? WHY YOU NO FIX THIS?
...
function displayResults(str, src) {
  ...
  if (src != 'hexNCRs') {
    hexNCRs.value = convertCharStr2SelectiveCPs(
      str,
      getParameters(document.getElementById('hexNCROptions')),
      true,
      '&#x',
      ';',
      'hex'
  ...
  if (src != 'decNCRs') {
    decNCRs.value = convertCharStr2SelectiveCPs(
      str,
      getParameters(document.getElementById('decNCROptions')),
      false,
      '&#',
      ';',
      'dec'
  ...
  if (src !== 'Unicode') {
    preserve = 'none';
    if (document.getElementById('unicodeascii').checked) {
      preserve = 'ascii';
    }
  ...
  if (src !== 'zeroX') {
    preserve = 'none';
    if (document.getElementById('zeroXascii').checked) {
      preserve = 'ascii';
    }
  ...
  if (src !== 'codePoints') {
    ...
    codePoints.value = convertCharStr2CP(
      str,
      preserve,
      document.getElementById('hexcppad').value,
      'hex',
      document.getElementById('hexcpascii').checked
    );
  }
  if (src != 'decCodePoints') {
    preserve = 'none';
    if (document.getElementById('deccpascii').checked) {
      preserve = 'ascii';
    }
...
function extractEscapes(strIn) {
  ...
  for (let i = 0; i < chars.length; i++) {
    if (chars[i] === '&' && chars[i + 1] === '#' && chars[i + 2] === 'x') {
      ...
      document.getElementById('numbers').value === 'hex' &&
      hexSet.has(chars[i].toLowerCase()) &&
      i < chars.length - 3 &&
      separatorSet.has(chars[i - 1].toLowerCase()) &&
      hexSet.has(chars[i + 1].toLowerCase())
    ) {
      let p = i + 1;
      let temp = ' ' + chars[i];
      ...
      document.getElementById('numbers').value === 'dec' &&
      decSet.has(chars[i].toLowerCase()) &&
      i < chars.length - 3 &&
      separatorSet.has(chars[i - 1].toLowerCase()) &&
      decSet.has(chars[i + 1].toLowerCase())
    ) {
      let p = i + 1;
      let temp = ' ' + chars[i];
...
export function convertAllEscapes(str) {
  ...
  str = convertGreenNumbers2Char(str, 'none');
  if (sle) str = convertSlashChar2Char(str);
  return str;
}

// convertAllEscapes("b'RT @wballaa: \\u0627\\u0644\\u062a\\u0645\\u0648\\u064a\\u0644 \\u0627\\u0644\\u062c\\u0631\\u064a\\u0621 \\u0634\\u0631\\u0627\\u0643\\u0629 \\u0637\\u0648\\u064a\\u0644\\u0629 \\u0627\\u0644\\u0645\\u062f\\u0649 \\u0648\\u0644\\u064a\\u0633 \\u0628\\u0639\\u0645\\u0644\\u064a\\u0629 \\u0628\\u064a\\u0639 \\u0648\\u0634\\u0631\\u0627\\u0621 \\u0639\\u0627\\u0628\\u0631\\u0629 \\u0648\\u0644\\u0630\\u0644\\u0643 \\u0647\\u0646\\u0627\\u0643 \\u0623\\u0633\\u0626\\u0644\\u0629 \\u062c\\u0648\\u0647\\u0631\\u064a\\u0629 \\u0643\\u0647\\u0630\\u0647 \\u0645\\u0646 \\u0627\\u0644\\u0645\\u0647\\u0645 \\u0645\\u0639\\u0631\\u0641\\u0629 \\u0625\\u062c\\u0627\\u0628\\u062a\\u0647\\u0627 \\u0644\\u0644\\u0631\\u064a\\u0627\\u062f\\u064a \\u0639\\u0646\\u062f \\u0627\\u2026'");
...
function convertuBracket2Char(str) {
  ...
  str = str.replace(/\\u\{([A-Fa-f0-9]{1,})\}/g, function (matchstr, parens) {
    return hex2char(parens);
  });
  return str;
}
...
function convertxBracket2Char(str) {
  ...
  // convert escapes to characters
  str = str.replace(/\\x\{([A-Fa-f0-9]{1,})\}/g, function (matchstr, parens) {
    return hex2char(parens);
  });
  return str;
}
...
function convertx002Char(str) {
  ...
  // convert escapes to characters
  str = str.replace(/\\x([A-Fa-f0-9]{2})/g, function (matchstr, parens) {
    return hex2char(parens);
  });
  return str;
}
...
function convertGreenNumbers2Char(str, type) {
  ...
  if (type === 'hex') {
    str = str.replace(/(\b[A-Fa-f0-9]{2,8}\b)/g, function (matchstr, parens) {
      return hex2char(parens);
    });
  } else if (type === 'dec') {
...
function convertCharStr2XML(str, parameters) {
  ...
  if (parameters.match(/convertinvisibles/)) {
    ...
    for (let i = 0; i < str.length; i++) {
      if (str.codePointAt(i) === 0x09 || str.codePointAt(i) === 0x0a || str.codePointAt(i) === 0x0d)
        newstring += str[i];
      else if (
  ...
  for (var i = 0; i < str.length; i++) {
    ...
    if (highsurrogate != 0) {
      if (0xdc00 <= cc && cc <= 0xdfff) {
        ...
        outputString +=
          ' ' +
          dec2hex2(0xf0 | ((suppCP >> 18) & 0x07)) +
          ' ' +
          dec2hex2(0x80 | ((suppCP >> 12) & 0x3f)) +
          ' ' +
          dec2hex2(0x80 | ((suppCP >> 6) & 0x3f)) +
          ' ' +
          dec2hex2(0x80 | (suppCP & 0x3f));
        highsurrogate = 0;
        continue;
      } else {
...
function convertCharStr2CP(textString, parameters, pad, type, mixed) {
  ...
  for (let i = 0; i < chars.length - 1; i++) {
    ...
    if (cp <= 127 && parameters.includes('ascii')) str += chars[i];
      ...
      switch (type) {
        case 'hex':
          number = chars[i].codePointAt(0).toString(16).toUpperCase();
